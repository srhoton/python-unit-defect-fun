...
def appconfig_env_vars():
    ...
    original_values = {}
    for key in ["APPCONFIG_APPLICATION_ID", "APPCONFIG_ENVIRONMENT_ID", "APPCONFIG_CONFIG_PROFILE_ID"]:
...
class TestAppConfigFunctions:
    ...
    def test_get_table_names(self, mock_appconfig, appconfig_env_vars):
        ...
        with mock.patch("python_unit_defect_fun.lambda_handler.get_appconfig_settings") as mock_get_config:
...
class TestLambdaHandler:
    ...
    def test_lambda_handler_exception(self, appconfig_env_vars):
        ...
        with mock.patch("python_unit_defect_fun.lambda_handler.get_table_names") as mock_get_table_names:
    ...
    def test_lambda_handler_insert(self, appconfig_env_vars):
        ...
        with mock.patch("python_unit_defect_fun.lambda_handler.get_table_names") as mock_get_table_names, \
             ...
             mock.patch("python_unit_defect_fun.lambda_handler.process_insert") as mock_process_insert, \
             mock.patch("python_unit_defect_fun.lambda_handler.process_update") as mock_process_update, \
             mock.patch("python_unit_defect_fun.lambda_handler.process_delete") as mock_process_delete:
            ...
            insert_event = create_dynamodb_event(
                "INSERT",
                new_image={"unitId": "unit123", "customerId": "customer456"}
            )
    ...
    def test_lambda_handler_remove(self, appconfig_env_vars):
        ...
        with mock.patch("python_unit_defect_fun.lambda_handler.get_table_names") as mock_get_table_names, \
            ...
            remove_event = create_dynamodb_event(
                "REMOVE",
                old_image={"unitId": "unit123", "customerId": "customer456"}
            )
